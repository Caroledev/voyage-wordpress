...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220726_voyage_0c53f8db35a3b43b5988_20220726143816_archive.zip';
	const ARCHIVE_SIZE		 = '52512141';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0c53f8d-26143816';
    const SECONDARY_PACKAGE_HASH = 'ec47b21-26143816';
	const VERSION			 = '1.4.7';
